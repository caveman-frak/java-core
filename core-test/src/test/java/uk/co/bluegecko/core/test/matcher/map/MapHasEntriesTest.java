...
public class MapHasEntriesTest
{
	...
	public final void testSuccessTwoEntry()
	{
		...
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected (a collection containing <1L>=\"One\" and a collection containing <10L>=\"Ten\")" ) );
	}
	...
	public final void testSuccessAllEntries()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected (a collection containing <1L>=\"One\" and a collection containing <2L>=\"Two\" and a collection containing <10L>=\"Ten\")" ) );
	}
	...
	public final void testFailureExtraEntry()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected (a collection containing <1L>=\"One\" and a collection containing <6L>=\"Six\")" ) );
	}
