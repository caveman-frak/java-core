...
public class MapContainsTest
{
	...
	public final void testContainsSuccess()
	{
		...
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable containing [<1L>=\"One\", <2L>=\"Two\", <10L>=\"Ten\"]" ) );
	}
	...
	public final void testContainsFailWrongOrder()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable containing [<2L>=\"Two\", <1L>=\"One\", <10L>=\"Ten\"]" ) );
	}
	...
	public final void testContainsFailMissingEntry()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable containing [<1L>=\"One\", <10L>=\"Ten\"]" ) );
	}
	...
	public final void testContainsFailExtraEntry()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable containing [<1L>=\"One\", <2L>=\"Two\", <6L>=\"Six\", <10L>=\"Ten\"]" ) );
	}
	...
	public final void testContainsFailWrongEntry()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable containing [<1L>=\"One\", <2L>=\"Two\", <6L>=\"Six\"]" ) );
	}
	...
	public final void testContainsInAnyOrderSuccess()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable over [<1L>=\"One\", <2L>=\"Two\", <10L>=\"Ten\"] in any order" ) );
	}
	...
	public final void testContainsInAnyOrderSuccessWrongOrder()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable over [<2L>=\"Two\", <1L>=\"One\", <10L>=\"Ten\"] in any order" ) );
	}
	...
	public final void testContainsInAnyOrderFailMissingEntry()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable over [<1L>=\"One\", <10L>=\"Ten\"] in any order" ) );
	}
	...
	public final void testContainsInAnyOrderFailExtraEntry()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable over [<1L>=\"One\", <2L>=\"Two\", <6L>=\"Six\", <10L>=\"Ten\"] in any order" ) );
	}
	...
	public final void testContainsInAnyOrderFailWrongEntry()
	{
		...
		matcher.describeMismatch( map, description );
		assertThat( description.toString(), is(
				"map was [<1=One>, <2=Two>, <10=Ten>] expected iterable over [<1L>=\"One\", <2L>=\"Two\", <6L>=\"Six\"] in any order" ) );
	}
}
