...
/**
 * Build a text representation of a number.
 */
public final class WordBuilder
{
	...
	/**
	 * Convert a text representation into a number
	 *
	 * @param value
	 *            the words
	 * @return the number
	 */
	public static int wordsToInt( final String value )
	{
		final StringBuilder buffer = new StringBuilder();
	...
	protected static String intToComplexWords( final int value )
	{
		return intToComplexWords( intToReversedDigits( value ) );
	}

	protected static String intToComplexWords( final char... digits )
	{
		final StringBuilder buffer = new StringBuilder();
	...
	private static String digitToWord( final char ch )
	{
		switch ( ch )
		{
			case '0':
	...
	private static char wordToDigit( final String word )
	{
		switch ( word )
		{
			case "Zero":
