...
public class RenderingHelperTest
{
	...
	public final void testGetDefaultHint()
	{
		...
		assertEquals( "foreground", 1, RenderingHelper.getHints( RenderingType.FOREGROUND, results )
				.size() );
		assertEquals( "background", 1, RenderingHelper.getHints( RenderingType.BACKGROUND, results )
				.size() );
		assertEquals( "font", 1, RenderingHelper.getHints( RenderingType.FONT, results )
				.size() );
		assertEquals( "border", 0, RenderingHelper.getHints( RenderingType.BORDER, results )
				.size() );

		assertEquals( "foreground.preferred", HintWeight.MIN_WEIGHT,
				RenderingHelper.getPreferredHint( RenderingType.FOREGROUND, results )
						.getWeight() );
		assertEquals( "background.preferred", HintWeight.MIN_WEIGHT,
				RenderingHelper.getPreferredHint( RenderingType.BACKGROUND, results )
						.getWeight() );
		assertEquals( "font.preferred", HintWeight.MIN_WEIGHT,
				RenderingHelper.getPreferredHint( RenderingType.FONT, results )
						.getWeight() );
	...
	public final void testGetDefaultHintSelected()
	{
		...
		assertEquals( "foreground", 2, RenderingHelper.getHints( RenderingType.FOREGROUND, results )
				.size() );
		assertEquals( "background", 2, RenderingHelper.getHints( RenderingType.BACKGROUND, results )
				.size() );
		assertEquals( "font", 1, RenderingHelper.getHints( RenderingType.FONT, results )
				.size() );
		assertEquals( "border", 0, RenderingHelper.getHints( RenderingType.BORDER, results )
	...
	public final void testGetDefaultHintFocused()
	{
		...
		assertEquals( "font", 1, RenderingHelper.getHints( RenderingType.FONT, results )
				.size() );
		assertEquals( "border", 1, RenderingHelper.getHints( RenderingType.BORDER, results )
				.size() );
		...
		assertEquals( "border.preferred", HintWeight.FOCUSED_WEIGHT,
				RenderingHelper.getPreferredHint( RenderingType.BORDER, results )
						.getWeight() );
	}
